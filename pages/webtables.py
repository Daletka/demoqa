...
class Tables(BasePage):
    ...
    def __init__(self, driver):
        ...
        self.headFirstName = WebElement(driver, "div.rt-thead.-header > div > div:nth-child(1)")
        self.headLastName = WebElement(driver, "div.rt-thead.-header > div > div:nth-child(2)")
        self.headAge = WebElement(driver, "div.rt-thead.-header > div > div:nth-child(3)")
        self.headEmail = WebElement(driver, "div.rt-thead.-header > div > div:nth-child(4)")
        self.headSalary = WebElement(driver, "div.rt-thead.-header > div > div:nth-child(5)")
        self.headDepartment = WebElement(driver, "div.rt-thead.-header > div > div:nth-child(6)")
        self.headAction = WebElement(driver, "div.rt-thead.-header > div > div:nth-child(7)")